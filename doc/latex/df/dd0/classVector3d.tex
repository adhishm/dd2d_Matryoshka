...
109 \}
\end{DoxyCode}
\hypertarget{classVector3d_a9fd3cba8bbdf983db6c2a2eae00c4b29}{\index{Vector3d@{Vector3d}!magnitude@{magnitude}}
...
{}
\end{DoxyParamCaption}
)}}\label{df/dd0/classVector3d_a9fd3cba8bbdf983db6c2a2eae00c4b29}
...
\begin{DoxyCode}
153 \{
154   \textcolor{keywordtype}{double} m = this->\hyperlink{classVector3d_a9fd3cba8bbdf983db6c2a2eae00c4b29}{magnitude} ();
155   
...
245     \{
246       r.x[i] = this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[i] * p;
247     \}
248   
...
277     \{
278       s += this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[i] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[i];
279     \}
280   
...
179     \{
180       r.x[i] = this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[i] + p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[i];
181     \}
182   
...
212     \{
213       r.x[i] = this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[i] - p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[i];
214     \}
215   
...
228     \{
229       this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[i] -= p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[i];
230     \}
231 \}
\end{DoxyCode}
...
292   
293   r.x[0] = (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[1] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[2]) - (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[2] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[1]);
294   r.x[1] = (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[2] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[0]) - (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[0] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[2]);
295   r.x[2] = (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[0] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[1]) - (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[1] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[0]);
296   
...
\begin{DoxyCode}
305 \{
306   \hyperlink{classVector3d}{Vector3d}* r = \hyperlink{classVector3d_aac098d8695c4288e4844835e62945244}{Vector3d}(0.0, 0.0, 0.0);
307   
308   r->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[0] = (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[1] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[2]) - (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[2] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[1]);
309   r->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[1] = (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[2] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[0]) - (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[0] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[2]);
310   r->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[2] = (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[0] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[1]) - (this->\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[1] * p.\hyperlink{classVector3d_ae5e82a2be7cc2e195e56875a5befe509}{x}[0]);
311   
312   *\textcolor{keyword}{this} = *r;
313   
314   \textcolor{keyword}{delete} (r);
315   r = NULL;
316 \}
\end{DoxyCode}
