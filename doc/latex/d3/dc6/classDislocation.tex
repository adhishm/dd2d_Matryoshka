...
\begin{DoxyCode}
119 \{
120   \hyperlink{classVector3d}{Vector3d} *globalSystem = \textcolor{keyword}{new} \hyperlink{classVector3d}{Vector3d}[3];     \textcolor{comment}{// Global co-ordinate systems}
121   \hyperlink{classVector3d}{Vector3d} *localSystem  = \textcolor{keyword}{new} \hyperlink{classVector3d}{Vector3d}[3];     \textcolor{comment}{// Dislocation co-ordinate system}
122   
123   \textcolor{comment}{// Vectors of the global co-ordinate system}
124   globalSystem[0] = \hyperlink{classVector3d}{Vector3d} (1.0, 0.0, 0.0);
125   globalSystem[1] = \hyperlink{classVector3d}{Vector3d} (0.0, 1.0, 0.0);
126   globalSystem[2] = \hyperlink{classVector3d}{Vector3d} (0.0, 0.0, 1.0);
127   
128   \textcolor{comment}{// Vectors of the dislocation co-ordinate system}
129   localSystem[0] = \hyperlink{classDislocation_aad45c2eaade195f374707afb648ed17e}{bvec}.\hyperlink{classVector3d_a24acba00068d9d1612404243f2a01078}{normalize} ();
130   localSystem[2] = \hyperlink{classDislocation_a69d16092777d9ead2d4eedf7c3d47877}{lvec}.\hyperlink{classVector3d_a24acba00068d9d1612404243f2a01078}{normalize} ();
131   localSystem[1] = (\hyperlink{classDislocation_a69d16092777d9ead2d4eedf7c3d47877}{lvec} ^ \hyperlink{classDislocation_aad45c2eaade195f374707afb648ed17e}{bvec}).normalize ();
132   
133   \textcolor{comment}{// Calculate rotation matrix}
134   this->\hyperlink{classDislocation_a5699d2984949af836396c8b7e5f21a5e}{rotationMatrix} = \hyperlink{classRotationMatrix}{RotationMatrix} (globalSystem, localSystem);
135 
136   \textcolor{comment}{// Release memory}
137   \textcolor{keyword}{delete} (globalSystem);  globalSystem = NULL;
138   \textcolor{keyword}{delete} (localSystem);   localSystem  = NULL;
139 \}
\end{DoxyCode}
...
\begin{DoxyCode}
209 \{
210   \textcolor{comment}{// Stress in the local co-ordinate system}
211   \hyperlink{classStress}{Stress} sigmaLocal = sigma.\hyperlink{classStress_a8bbcd34d10748bf6febd32213ac5bf8e}{rotate}(this->\hyperlink{classDislocation_a5699d2984949af836396c8b7e5f21a5e}{rotationMatrix});
212   \hyperlink{classVector3d}{Vector3d} force;
213 
214   \textcolor{comment}{// Check for CRSS condition}
215   \textcolor{keywordflow}{if} (sigmaLocal.\hyperlink{classMatrix33_ab53b3e37ad830a87a804cf26311ba088}{getValue}(0,1) >= tau\_crss)
216     \{ 
217       \hyperlink{classVector3d}{Vector3d} force = sigma * ((this->\hyperlink{classDislocation_aad45c2eaade195f374707afb648ed17e}{bvec})^(this->\hyperlink{classDislocation_a69d16092777d9ead2d4eedf7c3d47877}{lvec}));
218     \}
219 
220   \textcolor{keywordflow}{return} (force);
221 \}
\end{DoxyCode}
...
\begin{DoxyCode}
233 \{
234   \textcolor{keywordtype}{double} norm\_v0 = v0.\hyperlink{classVector3d_adeda019b2d7ee805dece85650bdf6ed6}{magnitude}();
235   \textcolor{keywordflow}{if} (norm\_v0 == 0.0)
236     \{
237       \textcolor{comment}{// This dislocation is not moving}
238       \textcolor{keywordflow}{return} (1000.0);
239     \}
240 
241   \textcolor{comment}{// Positions}
242   \hyperlink{classVector3d}{Vector3d} p0 = this->\hyperlink{classDefect_ad175c3f2b1fad6be48806dab69dfb32e}{getPosition}();
243   \hyperlink{classVector3d}{Vector3d} p1 = d.\hyperlink{classDefect_a2bfcc6736a19eb9c4c8803ea0ea1e3f7}{getPosition}();
244   \hyperlink{classVector3d}{Vector3d} p01 = p1 - p0;
245   \textcolor{keywordtype}{double} norm\_p01 = p01.\hyperlink{classVector3d_adeda019b2d7ee805dece85650bdf6ed6}{magnitude}();
246 
247   \textcolor{keywordflow}{if} (norm\_p01 == 0.0)
248     \{
249       \textcolor{comment}{// The dislocation is lying on top of the obstacle - so it should not move}
250       \textcolor{keywordflow}{return} (0.0);
251     \}
252   \textcolor{keywordflow}{else}
253     \{
254       \textcolor{comment}{// Find out if the dislocation is approaching the defect or not}
255 
256       \textcolor{comment}{// Velocities}
257       \hyperlink{classVector3d}{Vector3d} v01 = v1 - v0;
258       \textcolor{keywordtype}{double} norm\_v01 = v01.\hyperlink{classVector3d_adeda019b2d7ee805dece85650bdf6ed6}{magnitude}();
259       \textcolor{keywordtype}{double} dotProduct = v01 * p01;
260       \textcolor{keywordtype}{double} cosine = dotProduct/(norm\_v01 * norm\_p01);
261       \textcolor{keywordflow}{if} (cosine < 0.0)
262         \{
263           \textcolor{comment}{// The dislocation is approaching the other defect}
264           \textcolor{keywordflow}{return} ( (norm\_p01 - minDistance)/norm\_v01 );
265         \}
266       \textcolor{keywordflow}{else}
267         \{
268           \textcolor{comment}{// They are diverging}
269           \textcolor{comment}{// So any time increment will do}
270           \textcolor{keywordflow}{return} (1000.0);
271         \}
272     \}
273 \}
\end{DoxyCode}
...
\begin{DoxyCode}
109 \{
110   \textcolor{keywordflow}{return} (this->\hyperlink{classDislocation_a62c80daa260a3301baf1dceaab5d23d0}{mobile});
111 \}
\end{DoxyCode}
...
\begin{DoxyCode}
151 \{
152   \textcolor{keywordtype}{double} principalStresses[3];
153   \textcolor{keywordtype}{double} shearStresses[3];
154   \hyperlink{classVector3d}{Vector3d} r;  \textcolor{comment}{// Vector joining the present dislocation to the point p}
155   
156   r = p - this->\hyperlink{classDefect_aed2731c1beefc22e3db6ad5b18194cdd}{pos}; \textcolor{comment}{// Still in global coordinate system}
157   \hyperlink{classVector3d}{Vector3d} rLocal = this->\hyperlink{classDislocation_a5699d2984949af836396c8b7e5f21a5e}{rotationMatrix} * r;     \textcolor{comment}{// Rotated to local co-ordinate
       system}
158   
159   \textcolor{comment}{// Calculate the stress field in the local co-ordinate system}
160   \hyperlink{classStress}{Stress} sLocal = this->\hyperlink{classDislocation_a26f938bfb630c3ba1b13522d7a422b8c}{stressFieldLocal} (rLocal, mu, nu);
161   
162   \textcolor{comment}{// Calculate the stress field in the global co-ordinate system}
163   \textcolor{comment}{//Stress sGlobal = (this->rotationMatrix) * sLocal * (this->rotationMatrix.transpose());}
164   \hyperlink{classStress}{Stress} sGlobal = sLocal.\hyperlink{classStress_a8bbcd34d10748bf6febd32213ac5bf8e}{rotate} (this->\hyperlink{classDislocation_a5699d2984949af836396c8b7e5f21a5e}{rotationMatrix});
165   
166   \textcolor{keywordflow}{return} (sGlobal);
167 \}
\end{DoxyCode}
