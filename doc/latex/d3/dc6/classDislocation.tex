...
\begin{DoxyCode}
119 \{
120   \hyperlink{classVector3d}{Vector3d} globalSystem[3];     \textcolor{comment}{// Global co-ordinate systems}
121   \hyperlink{classVector3d}{Vector3d} localSystem[3];      \textcolor{comment}{// Dislocation co-ordinate system}
122   
...
135 \}
\end{DoxyCode}
\hypertarget{classDislocation_a13df53ead0e78bc33594c6afabc41dcb}{\index{Dislocation@{Dislocation}!force\-Peach\-Koehler@{force\-Peach\-Koehler}}
...
\end{DoxyParamCaption}
)}}\label{d3/dc6/classDislocation_a13df53ead0e78bc33594c6afabc41dcb}
...
Definition at line 201 of file dislocation.\-cpp.


\begin{DoxyCode}
202 \{
203   \textcolor{comment}{// Stress in the local co-ordinate system}
204   \hyperlink{classStress}{Stress} sigmaLocal = (this->\hyperlink{classDislocation_a5699d2984949af836396c8b7e5f21a5e}{rotationMatrix}) * (sigma) * (this->
      \hyperlink{classDislocation_a5699d2984949af836396c8b7e5f21a5e}{rotationMatrix})^;
205   \hyperlink{classVector3d}{Vector3d} force;
206 
207   \textcolor{comment}{// Check for CRSS condition}
208   \textcolor{keywordflow}{if} (sigmaLocal.\hyperlink{classMatrix33_a849bbdf7b456ddacf7185b087fca4015}{getValue}(0,1) >= tau\_crss)
209     \{ 
210       \hyperlink{classVector3d}{Vector3d} force = sigma * ((this->\hyperlink{classDislocation_aad45c2eaade195f374707afb648ed17e}{bvec})^(this->\hyperlink{classDislocation_a69d16092777d9ead2d4eedf7c3d47877}{lvec}));
211     \}
212 
213   \textcolor{keywordflow}{return} (force);
214 \}
\end{DoxyCode}
...
102 \}
\end{DoxyCode}
\hypertarget{classDefect_a270caed3561fa5fa284af6427b6ca2e4}{\index{Dislocation@{Dislocation}!get\-Position@{get\-Position}}
...
235   \hyperlink{classVector3d}{Vector3d} p0 = this->\hyperlink{classDefect_a270caed3561fa5fa284af6427b6ca2e4}{getPosition}();
...
266 \}
\end{DoxyCode}
\hypertarget{classDislocation_a6f9fa6b294f26af8f7e337988090bb80}{\index{Dislocation@{Dislocation}!is\-Mobile@{is\-Mobile}}
...
{}
\end{DoxyParamCaption}
)}}\label{d3/dc6/classDislocation_a6f9fa6b294f26af8f7e337988090bb80}
...
\begin{DoxyCode}
147 \{
148   \textcolor{keywordtype}{double} principalStresses[3];
149   \textcolor{keywordtype}{double} shearStresses[3];
150   \hyperlink{classVector3d}{Vector3d} r;  \textcolor{comment}{// Vector joining the present dislocation to the point p}
151   
152   r = p - this->\hyperlink{classDefect_aed2731c1beefc22e3db6ad5b18194cdd}{pos}; \textcolor{comment}{// Still in global coordinate system}
153   \hyperlink{classVector3d}{Vector3d} rLocal = this->\hyperlink{classDislocation_a5699d2984949af836396c8b7e5f21a5e}{rotationMatrix} * r;     \textcolor{comment}{// Rotated to local co-ordinate
       system}
154   
155   \textcolor{comment}{// Calculate the stress field in the local co-ordinate system}
156   \hyperlink{classStress}{Stress} sLocal = this->\hyperlink{classDislocation_a163d6c52c2281a1b7fa9aab058c8fb84}{stressFieldLocal} (rLocal, mu, nu);
157   
158   \textcolor{comment}{// Calculate the stress field in the global co-ordinate system}
159   \hyperlink{classStress}{Stress} sGlobal = (this->\hyperlink{classDislocation_a5699d2984949af836396c8b7e5f21a5e}{rotationMatrix}) * sLocal * (^(this->
      \hyperlink{classDislocation_a5699d2984949af836396c8b7e5f21a5e}{rotationMatrix}));
160   
161   \textcolor{keywordflow}{return} (sGlobal);
162 \}
\end{DoxyCode}
