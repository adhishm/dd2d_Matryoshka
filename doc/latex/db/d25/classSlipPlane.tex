...
Definition at line 346 of file slip\-Plane.\-cpp.


\begin{DoxyCode}
347  \{
348    std::vector<Dislocation>::iterator d;  \textcolor{comment}{// Iterator for dislocations}
349    std::vector<Vector3d>::iterator f;     \textcolor{comment}{// Iterator for forces}
350    std::vector<Stress>::iterator s;       \textcolor{comment}{// Iterator for stresses}
351 
352    s = this->\hyperlink{classSlipPlane_adaa1bb736c2912f5e06e7aa4553c1ebd}{dislocationStresses}.begin();
353    f = this->\hyperlink{classSlipPlane_a2a74ae1f66a59e53a3ca0c9b81b28f7d}{dislocationForces}.begin();
354 
355    \textcolor{keywordflow}{for} (d = this->\hyperlink{classSlipPlane_ad92c7c409f7e161db449528389180910}{dislocations}.begin(); d!=this->dislcoations.end(); d++)
356      \{
357        f = d->forcePeachKoehler (*s, tau\_crss);
358        s++;
359        f++;
360      \}
361  \}
...
Definition at line 314 of file slip\-Plane.\-cpp.


\begin{DoxyCode}
315  \{
316    std::vector<Dislocation>::iterator d1;  \textcolor{comment}{// Iterator for each dislocation}
317    std::vector<Dislocation>::iterator d2;  \textcolor{comment}{// Nested iterator}
318    std::vector<Stress>::iterator s;        \textcolor{comment}{// Iterator for the Stress}
319 
320    \hyperlink{classVector3d}{Vector3d} p;                             \textcolor{comment}{// Position vector}
321 
322    s = this->\hyperlink{classSlipPlane_adaa1bb736c2912f5e06e7aa4553c1ebd}{dislocationStresses}.begin();
323    \textcolor{keywordflow}{for} (d1=this->\hyperlink{classSlipPlane_ad92c7c409f7e161db449528389180910}{dislocations}.begin(); d1!=this->\hyperlink{classSlipPlane_ad92c7c409f7e161db449528389180910}{dislocations}.end(); d1++)
324      \{
325        *s = appliedStress;
326        p = d1->getPosition();
327        \textcolor{keywordflow}{for} (d2 = this->\hyperlink{classSlipPlane_ad92c7c409f7e161db449528389180910}{dislocations}.begin(); d2!=this->\hyperlink{classSlipPlane_ad92c7c409f7e161db449528389180910}{dislocations}.end(); d2++)
328          \{
329            \textcolor{keywordflow}{if} (d1==d2)
330              \{
331                \textcolor{keywordflow}{continue};
332              \}
333            \textcolor{keywordflow}{else}
334              \{
335                *s = *s + d2->stressField(p, mu, nu);
336              \}
337          \}
338      \}
339  \}
...
Definition at line 281 of file slip\-Plane.\-cpp.


\begin{DoxyCode}
282 \{
283   \hyperlink{classVector3d}{Vector3d} *unPrimed = \textcolor{keyword}{new} \hyperlink{classVector3d}{Vector3d}[3]; \textcolor{comment}{// Old system (global)}
284   \hyperlink{classVector3d}{Vector3d} *primed   = \textcolor{keyword}{new} \hyperlink{classVector3d}{Vector3d}[3]; \textcolor{comment}{// New system (local)}
285     
286   \textcolor{keywordtype}{int} i, j;
287   
288   \textcolor{comment}{// Prepare the global and local systems}
289   \textcolor{keywordflow}{for} (i=0; i<3; i++)
290   \{
291     \textcolor{keywordflow}{for} (j=0; j<3; j++)
292     \{
293       unPrimed[i].\hyperlink{classVector3d_ac20e0cda09c96f83cc41e23300c303ca}{setValue}(j, (\textcolor{keywordtype}{double})(i==j));
294     \}
295     
296     primed[i] = this->\hyperlink{classSlipPlane_a2e0139563665d1765f04582bfeebabc9}{getAxis}(i);
297   \}
298   
299   \textcolor{comment}{// Calculate the rotationMatrix}
300   this->\hyperlink{classSlipPlane_a1aa5aacccb6bb03d163a95251aa10d6c}{rotationMatrix} = \hyperlink{classRotationMatrix}{RotationMatrix}(unPrimed, primed);
301   
302   \textcolor{comment}{// Free memory}
303   \textcolor{keyword}{delete}(unPrimed);     unPrimed = NULL;
304   \textcolor{keyword}{delete}(primed);       primed = NULL;
305 \}
\end{DoxyCode}
...
Definition at line 368 of file slip\-Plane.\-cpp.


\begin{DoxyCode}
369  \{
370    std::vector<Dislocation>::iterator d;  \textcolor{comment}{// Iterator for dislocations}
371    std::vector<Vector3d>::iterator f;     \textcolor{comment}{// Iterator for forces}
372    std::vector<Vector3d>::iterator v;     \textcolor{comment}{// Iterator for velocities}
373 
374    d = this->\hyperlink{classSlipPlane_ad92c7c409f7e161db449528389180910}{dislocations}.begin();
375    f = this->\hyperlink{classSlipPlane_a2a74ae1f66a59e53a3ca0c9b81b28f7d}{dislocationForces}.begin();
376    v = this->\hyperlink{classSlipPlane_a107a3883169bf918664cb4e4fd4bd72c}{dislocationVelocities}.begin();
377 
378    \textcolor{keywordflow}{while} (v != this->\hyperlink{classSlipPlane_a107a3883169bf918664cb4e4fd4bd72c}{dislocationVelocities}.end())
379      \{
380        \textcolor{keywordflow}{if} (d->isMobile())
381          \{
382            *v = (*f)/B;
383          \}
384        d++;
...
264     axis = (this->\hyperlink{classSlipPlane_a52df6a08ab40ffd0dfb4a467e45d2835}{extremities}[1] - this->\hyperlink{classSlipPlane_a52df6a08ab40ffd0dfb4a467e45d2835}{extremities}[0]);
265   \}
266   
267   \textcolor{keywordflow}{if} (i==1)
268   \{
269     \textcolor{comment}{// Y-axis = Z x X}
270     axis = this->\hyperlink{classSlipPlane_a2e0139563665d1765f04582bfeebabc9}{getAxis}(2) ^ this->\hyperlink{classSlipPlane_a2e0139563665d1765f04582bfeebabc9}{getAxis}(0);
271   \}
272   
273   \textcolor{keywordflow}{return} ( axis.normalize() );
274 \}     
\end{DoxyCode}
...
\begin{DoxyCode}
138 \{
139   \textcolor{keywordflow}{return} (this->\hyperlink{classSlipPlane_a52df6a08ab40ffd0dfb4a467e45d2835}{extremities});
140 \}
\end{DoxyCode}
...
124   \{
125     \textcolor{keywordflow}{return} (this->\hyperlink{classSlipPlane_a52df6a08ab40ffd0dfb4a467e45d2835}{extremities}[i];
126   \}
...
\begin{DoxyCode}
74 \{
75   this->\hyperlink{classSlipPlane_a52df6a08ab40ffd0dfb4a467e45d2835}{extremities}[0] = *(ends);
76   this->\hyperlink{classSlipPlane_a52df6a08ab40ffd0dfb4a467e45d2835}{extremities}[1] = *(ends+1);
77 \}
\end{DoxyCode}
